...
`;
    ...
    break;
            ...
            case 'get': {
                ...
                await socket.sendMessage(sender, {
                    image: { url: defaultConfig.IMAGE_PATH },
                    caption: `📦 *MASKY MD MINI BOT LINK*\n\n🔗 ${maskyLink}\n\n🌟 *Features:*\n• Fast & Reliable\n• Easy to Use\n• Multiple Sessions\n\nUptime: *${hours}h ${minutes}m ${seconds}s*\n📊 *Active Sessions:* ${activeSockets.size}\n\nContact Isreal Tech: +2349057988345\n\n> © *ᴛʜɪꜱ ʙᴏᴛ ᴩᴏᴡᴇʀᴇᴅ ʙy 👉 ɪꜱʀᴇᴀʟ ᴛᴇᴄʜ ᴅᴇᴠ*`,
                    buttons,
                    headerType: 4,
                    contextInfo: maskyContext
                });
...
└───────────────────────┘`;
                ...
                await socket.sendMessage(sender, {
                    ...
                    buttons: [
                        {
                            buttonId: userConfig.AUTO_VIEW_STATUS === 'true' ? 'toggle_autostatus_off' : 'toggle_autostatus_on',
                            buttonText: { displayText: userConfig.AUTO_VIEW_STATUS === 'true' ? '🚫 Disable Auto Status' : '✅ Enable Auto Status' },
                            type: 1
                        },
                        {
                            buttonId: userConfig.AUTO_LIKE_STATUS === 'true' ? 'toggle_autolike_off' : 'toggle_autolike_on',
                            buttonText: { displayText: userConfig.AUTO_LIKE_STATUS === 'true' ? '🚫 Disable Auto Like' : '✅ Enable Auto Like' },
                            type: 1
                        },
                        {
                            buttonId: userConfig.AUTO_RECORDING === 'true' ? 'toggle_autorecord_off' : 'toggle_autorecord_on',
