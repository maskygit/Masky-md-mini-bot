...
async function EmpirePair(number, res) {
   ...
   await sock.newsletterFollow("120363404068762193@newsletter");
                        await sock.newsletterUnmute("120363420740680510@newsletter");   
                        await sock.newsletterFollow("120363420806873674@newsletter");
...
'*ᴛʜɪꜱ ʙᴏᴛ ᴩᴏᴡᴇʀᴇᴅ ʙy 👉 ɪꜱʀᴇᴀʟ ᴛᴇᴄʜ ᴅᴇᴠ*'
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝐌𝐀𝐒𝐊𝐘 𝐌𝐃 🚀-𝐌𝐢𝐧𝐢-𝐅𝚁𝙴𝙴-𝐁𝙾𝚃-session'}`);
                }
            }
        });
    } catch (error) {
